...
const creatorAchievementBoostByUsername = {
  "@CR_Adventures": 6,
  "@BeachExplorer7": 22,
  "@MountainViews": 54,
};
const achievementFiveIconUri = "data:image/png;base64,";
...
export default function App() {
  ...
  useEffect(() => {
    if (!["buscar", "detalle", "resultados", "agregar"].includes(activeTab)) return;
  ...
  const renderCreatorDetail = () => {
    ...
    const creatorAchievementCount =
      creatorSpots.length + (creatorAchievementBoostByUsername[selectedCreator.username] || 0);
      ...
      <View style={styles.profileEditorCard}>
        ...
        <View style={styles.instagramProfileTopRow}>
          ...
          <View style={styles.instagramCountersRow}>
            ...
            <TouchableOpacity style={styles.instagramCounterItem} onPress={() => {
            ...
            >
              {achievement.target === 5 ? (
                <View style={[styles.firstAchievementIconBadge, !achievement.unlocked && styles.firstAchievementIconBadgeLocked]}>
                  <Image source={{ uri: achievementFiveIconUri }} style={styles.firstAchievementIconImage} />
                </View>
              ) : (
        ...
        <Modal
          ...
          transparent
          animationType="fade"
          onRequestClose={() => setIsConnectionsModalVisible(false)}
        >
          <View style={styles.connectionsModalBackdrop}>
            <View style={styles.connectionsModalCard}>
              <View style={styles.publicHeaderRow}>
                <Text style={styles.filterTitle}>Conexiones</Text>
                <TouchableOpacity onPress={() => setIsConnectionsModalVisible(false)}>
              ...
              <ScrollView style={styles.connectionsModalList}>
                {visibleConnections.length ? (
                  visibleConnections.map((username) => (
                    <TouchableOpacity
                      key={`modal-${connectionTab}-${username}`}
                      style={styles.connectionListRow}
                      onPress={() => {
                        setIsConnectionsModalVisible(false);
...
const styles = StyleSheet.create({
  ...
  firstAchievementIconImage: {
    width: 24,
    height: 24,
    borderRadius: 12,
  },
  connectionsModalBackdrop: {
    flex: 1,
